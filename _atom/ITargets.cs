...
{
    static readonly string[] ProjectsToPack = [Projects.DecSm_Extensions_Hosting.Name];
    static readonly string[] ProjectsToTest = [Projects.DecSm_Extensions_Hosting_Tests.Name];
